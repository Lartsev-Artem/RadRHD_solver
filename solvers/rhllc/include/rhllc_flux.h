 ...
 *
 */
#if !defined RHLLC_FLUX_STAB_H && defined RHLLC
...
namespace rhllc
{
    ...
    flux_t GetConvValue(const flux_t &W);
     ...
     *  - 4 = NaN
     */
    int GetPhysValue(const flux_t &U, flux_t &W);
     ...
     */
    Type GetFlux(const flux_t &conv_val_l, const flux_t &conv_val_r,
