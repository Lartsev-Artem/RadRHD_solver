#if 0 && defined ILLUM && defined SOLVERS // && !defined USE_MPI
...
#pragma omp for
    for (int num_direction = 0; num_direction < num_directions; ++num_direction) {
      ...
      for (int cell = 0; cell < num_cells; cell++) {
        grid.scattering[num_direction * num_cells + cell] = GetS(grid.size * CELL_SIZE, CELL_SIZE * cell, direction, grid.Illum, grid_direction);
      }
    }
  }
  return 0;
