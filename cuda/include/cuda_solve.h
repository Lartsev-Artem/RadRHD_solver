...
void CudaEventPrint();
void CudaSyncStream(const cuda::e_cuda_stream_id_t stream_id);
int CalculateIntScatteringAsyncMPIStream(const grid_directions_t &grid_dir, grid_t &grid,
                                         const int start, const int end, const cuda::e_cuda_stream_id_t stream);
...
int CalculateAllParamStream(const grid_directions_t &grid_dir, grid_t &grid, cuda::e_cuda_stream_id_t st);
